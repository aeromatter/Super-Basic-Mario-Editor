...
Public Class Blocks
    ...
    Public Shared Sub FillBlock(X As UInteger, Y As UInteger, Width As UInteger, Height As UInteger)
        ...
        If MainWindow.safemodeCheckBox.CheckState = CheckState.Checked Then
            While Filled = False
                For Each i As Rectangle In fillq.ToList
                    If (i.X >= 0 And i.X <= ((LevelWindow.AutoScrollPosition.X * -1) + LevelWindow.Width)) And (i.Y >= 0 And i.Y <= ((LevelWindow.AutoScrollPosition.Y * -1) + LevelWindow.Height)) Then
        ...
        If Filled = True Then
            For Each i As Rectangle In fillq
                ...
                'fill.IMG = ObjectPlacement.TB.Image
                'fill.Width = i.Width
                'fill.Height = i.Height
                'fill.ID = ObjectPlacement.SelectedBlock
